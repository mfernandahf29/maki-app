...
export default function StudentMenu() {
  ...
  const progresoMate = loadingProgress ? null : (progresoData.mate ?? 0);
  const progresoLenguaje = loadingProgress ? null : (progresoData.lenguaje ?? 0);
  ...
  return (
    <div className="bg-surface text-on-surface min-h-screen pt-20 pb-24 md:pb-0 font-body-md">
      ...
      <header className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-4 md:px-16 h-20 bg-surface shadow-sm">
        ...
        <div className="flex items-center gap-4 md:gap-8">
          <div className="hidden md:flex items-center gap-2 bg-surface-container-high px-4 py-2 rounded-full font-body-lg text-primary">
            <span
              className="material-symbols-outlined text-[#feb246]"
      ...
      <main className="max-w-[1400px] mx-auto px-4 md:px-16 py-12">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="order-1 md:order-2 flex justify-center md:justify-end items-center h-48 md:h-64">
            <div className="w-40 h-40 md:w-56 md:h-56 bg-secondary-container rounded-full flex items-center justify-center animate-floating shadow-[0_10px_30px_rgba(254,178,70,0.3)] border-4 border-white relative">
              ...
              <span
                className="absolute top-1/2 -left-6 text-2xl animate-pulse"
            ...
            <div className="flex items-center gap-6 z-10">
              ...
              <div>
                <h2 className="font-headline-md text-headline-md font-bold text-white flex items-center gap-2">
                  Explorar con Realidad Aumentada{" "}
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Course Card: Math */}
            <article
              className="bg-white/85 backdrop-blur-md border-2 border-surface-variant rounded-[2rem] p-8 flex flex-col gap-6 relative overflow-hidden group animate-pop-in shadow-lg"
              style={{ animationDelay: "0.2s", borderColor: "#feb246", borderWidth: "4px" }}
            >
              ...
              <div className="flex justify-center py-4">
                <span className="text-[4rem] group-hover:scale-110 transition-transform duration-300 drop-shadow-md select-none">
                  🔢
                </span>
              </div>
              <div className="text-center">
                <h3 className="font-headline-md text-[24px] font-bold text-on-background">
                  Matemáticas Mágicas
                </h3>
              ...
              <div className="w-full space-y-2">
                <div className="flex justify-between font-label-lg">
                  ...
                  <span className="text-primary font-bold">
                    {progresoMate === null ? "..." : `${progresoMate}%`}
                  </span>
                </div>
                <div className="h-4 w-full bg-surface-variant rounded-full overflow-hidden">
                  <div
                    ...
                    style={{ width: progresoMate === null ? "0%" : `${progresoMate}%` }}
                  />
                </div>
              </div>
            ...
            <article
              className="bg-white/85 backdrop-blur-md border-2 border-surface-variant rounded-[2rem] p-8 flex flex-col gap-6 relative overflow-hidden group animate-pop-in shadow-lg"
              style={{ animationDelay: "0.3s", borderColor: "#29abd4", borderWidth: "4px" }}
            >
              <div className="absolute top-4 right-4 bg-secondary-container text-on-secondary-container px-3 py-1 rounded-full font-label-lg flex items-center gap-1 shadow-sm">
                <span
                  className="material-symbols-outlined text-sm"
              ...
              <div className="text-center">
                ...
                <p className="font-body-md text-on-surface-variant">
                  Descubre nuevas letras y sonidos.
                </p>
              </div>
              <div className="w-full space-y-2">
                <div className="flex justify-between font-label-lg">
                  <span className="text-primary font-bold">Progreso</span>
                  <span className="text-primary font-bold">
                    {progresoLenguaje === null ? "..." : `${progresoLenguaje}%`}
                  </span>
                </div>
                <div className="h-4 w-full bg-surface-variant rounded-full overflow-hidden">
                  <div
                    className="h-full bg-primary-container rounded-full transition-all duration-700"
                    style={{ width: progresoLenguaje === null ? "0%" : `${progresoLenguaje}%` }}
                  />
                </div>
              </div>
              <div className="flex flex-col gap-4 mt-auto pt-4">
            ...
            <article
              className="bg-white/85 backdrop-blur-md border-2 border-surface-variant rounded-[2rem] p-8 flex flex-col gap-6 relative overflow-hidden group opacity-80 grayscale-[30%] animate-pop-in shadow-lg"
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="font-body-md text-on-surface-variant">
                  Conoce a los animales y plantas.
                </p>
              </div>
              <div className="w-full space-y-2">
                <div className="flex justify-between font-label-lg">
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-4 pb-4 pt-2 bg-surface shadow-[0_-4px_12px_rgba(0,103,130,0.1)] rounded-t-xl">
        <a
          href="#"
          className="flex flex-col items-center justify-center bg-secondary-container text-on-secondary-container rounded-2xl px-6 py-2 active:scale-90 transition-transform"
        >
        ...
        <a
          href="#"
          className="flex flex-col items-center justify-center text-on-surface-variant px-4 py-2 hover:bg-primary-container/20 rounded-2xl"
        >
